...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/progress_bar.js":[function(require,module,exports) {
var audio = document.getElementById('playback');
audio.volume = 0.10;
var isPlaying = false;
var playpauseBtn = document.querySelectorAll('.play-pause-action');
playpauseBtn.forEach(function (btn) {
...
;
var button = document.getElementById('progress-bar__button');
var progressBar = document.querySelector('.progress-bar');
var leftbar = document.querySelector('.progress-bar__bar__time');
var actualTimeSpan = document.querySelector('.progress-bar__time');
var durationSpan = document.querySelector('.progress-bar__duration');
var clicking = false;
...
function progressBarAuto() {
  if (clicking == false) {
    ...
    var _percentage = actualTime / duration * 100;

    leftbar.style.width = _percentage + '%';
  }
}
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/progress_bar.js"], null)
//# sourceMappingURL=/progress_bar.d91ada3d.js.map